...
#include <memory>
#include "../../bank_automat/menupage.h"
...
QT_MOC_LITERAL(3, 21, 4), // "page"
QT_MOC_LITERAL(4, 26, 6), // "logOut"
QT_MOC_LITERAL(5, 33, 11), // "logOutClick"
QT_MOC_LITERAL(6, 45, 10), // "saldoClick"
QT_MOC_LITERAL(7, 56, 13), // "withdrawClick"
QT_MOC_LITERAL(8, 70, 13), // "transactClick"
QT_MOC_LITERAL(9, 84, 14) // "payCreditClick"

    },
    "MenuPage\0changePage\0\0page\0logOut\0"
    "logOutClick\0saldoClick\0withdrawClick\0"
    "transactClick\0payCreditClick"
};
...
void MenuPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->logOutClick(); break;
        case 3: _t->saldoClick(); break;
        case 4: _t->withdrawClick(); break;
        case 5: _t->transactClick(); break;
        case 6: _t->payCreditClick(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MenuPage::*)(quint32 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuPage::changePage)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MenuPage::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuPage::logOut)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MenuPage::changePage(quint32 _t1)
{
