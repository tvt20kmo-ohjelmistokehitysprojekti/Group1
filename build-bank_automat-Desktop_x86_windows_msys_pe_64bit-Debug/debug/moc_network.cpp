...
#include <memory>
#include "../../bank_automat/network.h"
...
QT_MOC_LITERAL(1, 8, 10), // "setRespose"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 8) // "response"

    },
    "Network\0setRespose\0\0response"
};
...
void Network::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setRespose((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Network::setRespose)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Network::setRespose(QString _t1)
{
